...
function create() {
    // buttons
    const foodButton = this.add.text(WINDOW_WIDTH - 10, 52, 'Food', {
        font: '20px Arial',
        fill: '#0f0'
    });
    ...
    const waterButton = this.add.text(WINDOW_WIDTH - 10, 31, 'Water', {
        font: '20px Arial',
        fill: '#0f0'
    });
    ...
    const metalButton = this.add.text(WINDOW_WIDTH - 10, 73, 'Metal', {
        font: '20px Arial',
        fill: '#0f0'
    });
